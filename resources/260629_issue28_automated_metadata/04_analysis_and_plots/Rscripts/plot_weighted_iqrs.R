...
# Define paths
data_file <- "resources/260629_issue28_automated_metadata/data/Weighted IQRs.csv"
output_dir <- "plots"
...
# Function to generate and save histogram with median line & label
...
# Generate plots for temp_min, temp_optimum, and temp_max
create_temp_histogram(df, "temp_min_weighted_iqr", "Minimum Temperature Weighted IQR", "temp_min_weighted_iqr_histogram.png")
create_temp_histogram(df, "temp_optimum_weighted_iqr", "Temperature Optimum Weighted IQR", "temp_optimum_weighted_iqr_histogram.png")
create_temp_histogram(df, "temp_max_weighted_iqr", "Maximum Temperature Weighted IQR", "temp_max_weighted_iqr_histogram.png")

message("Done generating all plots.")
